...
| Firebase Auth Admin SDK visibility of a deleted user (that a read returns the user as absent immediately after deletion) | [sync.md](sync.md), [security.md](security.md) |
