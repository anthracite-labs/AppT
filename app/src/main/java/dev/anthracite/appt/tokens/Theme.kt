...
/**
 * Binds the AppT tokens to Material 3 so Compose's own defaults can never
 * introduce an untokenised colour or text size.
 *
 * ui-ux.md: Material foundations are used where useful, with the dark remote
 * surface as the primary design reference.
 */
@Composable
